...
namespace Zek.Utils
{
    ...
    {
        public static byte[] Compress(byte[] buffer, CompressType compressType = CompressType.None)
        {
            switch (compressType)
            {
        ...
        public static byte[] Decompress(byte[] compressedBuffer, int? compressTypeId = null)
        {
            return Decompress(compressedBuffer, compressTypeId.HasValue ? (CompressType)compressTypeId.Value : CompressType.None);
        }
        ...
        public static byte[] Decompress(byte[] compressedBuffer, CompressType compressType = CompressType.None)
        {
            switch (compressType)
            {
                case CompressType.GZip:
