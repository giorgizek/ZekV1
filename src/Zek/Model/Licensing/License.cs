...
namespace Zek.Model.Licensing
{
    ...
    public class LicenseMap : EntityTypeMap<License>
    {
        public LicenseMap(ModelBuilder builder) : base(builder)
        {
            ...
            Property(t => t.DateExpires).ForSqlServerHasColumnType("datetime2(0)");
            Property(t => t.DateGenerated).ForSqlServerHasColumnType("datetime2(0)");
            Property(t => t.DateLastUsed).ForSqlServerHasColumnType("datetime2(0)");
