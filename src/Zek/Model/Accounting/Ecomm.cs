...
namespace Zek.Model.Accounting
{
    ...
    public class EcommMap<TEntity> : PocoModelMap<TEntity, int> where TEntity : Ecomm
    {
        public EcommMap(ModelBuilder builder, bool? valueGeneratedOnAdd = null) : base(builder, valueGeneratedOnAdd)
        {
            ...
            Property(e => e.Amount).ForSqlServerHasColumnType("money").HasDefaultValue(0m);
            Property(e => e.ReversalAmount).ForSqlServerHasColumnType("money").HasDefaultValue(0m);
            ...
            Property(e => e.RegularPaymentExpiry).ForSqlServerHasColumnType("date");
