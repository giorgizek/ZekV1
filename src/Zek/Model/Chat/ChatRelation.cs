...
namespace Zek.Model.Chat
{
        ...
        where TChat : ChatPoco
    {
        public ChatRelationPocoMap(ModelBuilder builder) : base(builder)
        {
            ...
            Property(t => t.RoleId).HasDefaultValue(0);

            Property(t => t.IsDeleted).HasDefaultValue(false);
            HasIndex(t => t.IsDeleted);

            Property(t => t.DeleteDate).ForSqlServerHasColumnType("datetime2(0)").ForSqlServerHasDefaultValueSql("sysdatetime()");
        }
